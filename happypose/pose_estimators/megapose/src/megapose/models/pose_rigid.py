...
# MegaPose
from happypose.toolbox.lib3d.camera_geometry import boxes_from_uv, get_K_crop_resize
from happypose.toolbox.lib3d.camera_geometry import (
    project_points_robust as project_points_robust,
)
from happypose.toolbox.lib3d.cosypose_ops import pose_update_with_reference_point
from happypose.toolbox.lib3d.cropping import deepim_crops_robust as deepim_crops_robust
...
from happypose.toolbox.lib3d.transform_ops import normalize_T
...
class PosePredictor(nn.Module):
    ...
    def normalize_depth(self, depth: torch.Tensor, tCR: torch.Tensor) -> torch.Tensor:
        ...
        if self.depth_normalization_type == "tCR_scale":
            ...
            raise ValueError(
                f"Unknown depth_normalization_type = {self.depth_normalization_type}",
            )
